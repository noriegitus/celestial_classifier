...
save_metrics_to_csv("resnet18_v2", metrics)
save_predictions_to_csv("resnet18_v2", predictions_list)

print("Métricas y predicciones para ResNet18 v2 guardadas exitosamente.")